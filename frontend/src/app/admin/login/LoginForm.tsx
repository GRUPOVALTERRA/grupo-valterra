...
/**
 * Formulario de acceso al panel — SPEC-S23.
 *
 * Un solo metodo: magic link de Supabase Auth. La pestana "Emergencia"
 * (password -> cookie ADMIN_TOKEN) fue retirada junto con su server action.
 */
export function LoginForm({ magicAction, nextPath, initialError }: LoginFormProps) {
  const initialMsg = (() => {
    switch (initialError) {
