  ...
  return (
    <section className="relative isolate min-h-[760px] overflow-hidden pt-24 md:min-h-[840px] md:pt-32">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(10,37,64,0.92) 0%, rgba(6,24,48,0.75) 50%, rgba(10,37,64,0.85) 100%)",
        }}
      />
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 md:py-20 lg:px-8">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-5 text-4xl font-semibold leading-[1.05] text-white sm:text-5xl md:text-6xl lg:text-[64px]">
